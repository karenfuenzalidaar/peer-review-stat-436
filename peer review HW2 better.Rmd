...
## Define color scheme for the restaurants based on rank
...
server <- function(input, output) {
  ...
  # Reactive filter for year and rank
  ...
  # Render interactive map using the external function `createLeafletMap`
