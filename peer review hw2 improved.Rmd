...
# Function to create the filtered table
...
# UI
ui <- fluidPage(
  theme = bs_theme(version = 5),  # Apply Bootstrap 5 theme using bslib
  ...
  # Scatter Plot and Filtered Data Table
  fluidRow(
    column(12,
           card(
             title = "Scatter Plot",
  ...
  # Filtered Data Information (One Table for both filter and brush)
  fluidRow(
    column(12,
           card(
...
server <- function(input, output) {
  ...
  # Filtered data based on sliders and location
  ...
  # Combine filtered data and brushed data
  ...
  # Render the scatter plot using the external function
  ...
  # Render the filtered table using the external function
